 ...
 * {@link userProfileFrag.OnFragmentInteractionListener} interface
...
public class userProfileFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View output = inflater.inflate( R.layout.fragment_user_profile, container, false );
        update_profile_button= output.findViewById( R.id.update_profile_button );
        update_profile_button.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setAndupdateProfileFrag homeFragment = new setAndupdateProfileFrag();
